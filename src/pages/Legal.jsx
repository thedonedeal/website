...
<article id="tab-investor" className="legal-doc" style={{display: tab === 'investor' ? '' : 'none'}}>
  ...
  <div className="intro">
    <p>These terms and conditions govern the access to, or use of the services made available through our website (the “<a className="inline" href="https://www.done.deals" target="_blank" rel="noopener noreferrer"><strong>Platform</strong></a>” and together with services made available on or through the Platform, the “<strong>Services</strong>”).</p>
